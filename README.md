...
## 🎯 Актуальные паттерны (версия 1.6.5)
...
- ✅ Оптимизирована производительность (интервал 1-5 секунд)
...
3. Скопируйте содержимое `Russian-Uncensored-Words-Highlight-1.6.5.user.js`
