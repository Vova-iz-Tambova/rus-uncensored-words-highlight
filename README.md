...
### 🖱 Контекстное меню
Выделите слово на странице, нажмите правой кнопкой — добавьте его в любой список или удалите из списка.

### ⚡ Динамические страницы
Работает с динамическим контентом: чаты, ленты, SPA — MutationObserver + setInterval(fallback) для всех изменений DOM.

## 🎯 Актуальные паттерны (версия 2.0.0)
...
- ✅ Игнорирование ударений и диакритических знаков
