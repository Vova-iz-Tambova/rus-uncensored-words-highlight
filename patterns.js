...
const PATTERN_EB = '(?<![вВгГдДзЗкКлЛнНпПрРсСтТцЦчЧшШщЩ])[еЕёЁëË][бБⳝпП](?![аАеЕиИлЛнНоОрРсСтТ])';
const PATTERN_EBA = '(?<![бБвВгГдДжЖкКлЛмМнНпПрРсСтТцЦчЧшШщЩЗзЗcCdDrRmM]|[вВ][оО])[еЕeEёЁëε][бБьЬ6δⳝb][аАaA@αАеЕёЁиИμлЛнН0оОoOуУyYыЫ][рРвВеЕйЙнНрРуУyжЖлЛӆбБкКоОтТчЧшШщЩ]?(?![ҙ]|[сС][оО])'; // |[еЕсСьЬхХ][еЕиИзЗкКнНшШчЧ]|[иИкКнНуУ][лЛоОтТпП][еЕлЛоОпП]
...
const PATTERN_IBI = '(?<![бБвВГгдДкКлЛмМнНпПсСрРтТшШчЧхХцЦфФ])[иИμ][бБⳝ][аАеЕиИμуУ](?![рРсСцЦ])';
